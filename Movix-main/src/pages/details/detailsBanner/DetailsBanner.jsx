...
const DetailsBanner = ({ video, crew }) => {
    ...
    const addToUserList = async () => {
        ...
        const endpoint = mediaType === 'movie' ? '/add-movie' : '/add-tv';
        ...
        try {
            const response = await fetch(`http://localhost:3001${endpoint}`, {
                ...
                body: JSON.stringify({ userId:userId, movieortvId: id, Title:title })
            });
            ...
            setAddStatus('Error adding item to list.');
            setMessage('Error adding item to list');
            setShowSnackbar(true);
            setTimeout(() => {
                setShowSnackbar(false);
            }, 3000);
